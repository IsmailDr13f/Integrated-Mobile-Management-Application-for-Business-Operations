...
export default function HomeBL() {
    ...
    const empCollectionRef = collection(db, "BL");
      ...
      <Paper sx={{ width: '100%', overflow: 'hidden' }}>
          ...
          <Stack style={{marginBottom:15}} direction="row" spacing={2} className="my-2 mb-2">
            ...
            sx={{ width: 300 }}
              ...
              renderInput={(params) => (
                <TextField {...params} size="small" label="Chercher un BL par Nom de Client" />
              )}
            />
            <Typography
              variant="h6"
                                ...
                                rows
                                    .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((rw) => {
                                        ...
                                        return (
                                            ...
                                            <TableCell key={rw.id} align='left'>
                                            <PDFDownloadLink document={<BonLivraisonPDF bon={rw} />} fileName={rw.NBL+'.pdf'}>
